...
| Kingdom key figures | all five kingdom files | All five filled |
| Agoran lore pass | `world/kingdoms/agoran.md` | DONE — full build-out: power structure, key figures, GM notes, and links to the Fall, the King's Heart, and the Hollowing |
...
3. [x] **Agoran** — DONE. Capital: [Commonhold](locations/commonhold.md) (the city of tables, the leaning flame of the Common Hearth, the rolls of belonging, the Setting-Out). Power structure: the King's Table / the rolls / the wardens ([agoran.md](world/kingdoms/agoran.md)). Enforcer apparatus + the king's movement named: **[the Found](world/factions/the-found.md)** (the Wardens, the quiet corps, the Dousers, the Gleaner). Dissenters + exiles: **[the Eleventh Chair](world/factions/the-eleventh-chair.md)** (the Downsmoot under the six dancers, the chair-keepers inside Agoran, the fork-island camp). Key figures: [Bram Harrow](characters/npcs/bram-harrow.md) (the Warden-General, Tier 3), [Iveth Kall](characters/npcs/iveth-kall.md), [Oren Brandt](characters/npcs/oren-brandt.md). GM Notes completed: arc role, three levers, the two graces, what healing looks like.
4. [x] **Luminar** — DONE. Capital: [Prismere](locations/prismere.md) (the drowned river-mouth, the Season, the Glasshouse over the Heart, the tide that applauds). Power structure: the Luminary / the Gasp / the Understage ([luminar.md](world/kingdoms/luminar.md)), with "art that harms" written up for play (the Raw school, the Ordeal debuts, unbound invention). The artist the king wants: **[Vess Tallow, the Finisher](characters/npcs/vess-tallow.md)** — her given works survive completion. The push: the Undertide serial running dry while **[Marlow Pitch](characters/npcs/marlow-pitch.md)** (Tier 2 lieutenant) holds [Dorel Vane](characters/npcs/dorel-vane.md)'s debts and the king's bought finale. Resistance: **[the Encore](world/factions/the-encore.md)**. GM Notes completed: arc role, three levers, staging the Finale, what healing looks like.
5. [x] **Veritas** — DONE. Capital: [Meridian](locations/meridian.md) (the grid-city that douses its lamps for the stars, the noon concordance, the Great Archive and its Deep Stacks). Power structure: the Assay / priority as currency / the Claim-Vault ([veritas.md](world/kingdoms/veritas.md)), with "the priority wars" written up for play. The scholar who knows too much: **[Edda Prine, the Last Reader](characters/npcs/edda-prine.md)** — only living reader of the Vael corpus, one telling left in her. The push: the Concordance pipeline run by **[Ansel Marr, the Correspondent](characters/npcs/ansel-marr.md)** (Tier 2 lieutenant) with Vael's sealed-unread want-list riding inside it. Resistance: **[the Marginalia](world/factions/the-marginalia.md)**. Key figures: [Vesna Corle](characters/npcs/vesna-corle.md), Prine, Marr, [Annot Fell](characters/npcs/annot-fell.md). GM Notes completed: arc role, three levers, staging the Reading, what healing looks like.

### Phase 3 — The campaign spine (villains, factions, quests)

- [x] **Korrven's lieutenants** — DONE: ~~a recruiter who offers belonging~~ (**the Gleaner**, Tier 1, sketch-statted in [the Found](world/factions/the-found.md)), ~~an emissary in Forgeholm~~ (**[Ilsabet Krane](characters/npcs/ilsabet-krane.md)**, Tier 2, statted), ~~an agent in Sophara~~ (**[Maro Tallis](characters/npcs/maro-tallis.md)**, Tier 2, social adversary), ~~an enforcer commander in Agoran~~ (**[Warden-General Bram Harrow](characters/npcs/bram-harrow.md)**, Tier 3, statted — commands both the King's Wardens and the Dousers). The ladder Tier 1→3 is complete; add more only if an arc needs one. The Luminar arc needed one: **[Marlow Pitch, the Patron](characters/npcs/marlow-pitch.md)** (Tier 2, social adversary — the impresario running the Northbound talent pipeline). So did Veritas: **[Ansel Marr, the Correspondent](characters/npcs/ansel-marr.md)** (Tier 2, social adversary — the man who answers every letter, running the Concordance pipeline).
- [ ] **Faction files** (`world/factions/`): ~~the king's movement~~ — DONE: **[the Found](world/factions/the-found.md)**. ~~The Agoran resistance/exiles~~ — DONE: **[the Eleventh Chair](world/factions/the-eleventh-chair.md)**. ~~The Forgeholm resistance~~ — DONE: **[the Second Stamp](world/factions/the-second-stamp.md)**. ~~At least one cross-kingdom faction that predates the isolation~~ — DONE: **[the Wayfair](world/factions/the-wayfair.md)**, the nomadic festival-caravan (unknowing heirs of Amaranth; their Loosening is the re-tuning mechanic in miniature, and they anchor the Session 1 hook in Forgeholm). ~~The Luminar resistance~~ — DONE: **[the Encore](world/factions/the-encore.md)**, the secret audience that remembers. ~~The Veritas faction~~ — DONE: **[the Marginalia](world/factions/the-marginalia.md)**, the conversation in the margins. All planned faction files exist.
