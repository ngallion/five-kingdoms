...
| Factions | `world/factions/` | Wayfair, the Second Stamp (Forgeholm), the Closed Hand (Sophara), **the Found** (the king's movement), **the Eleventh Chair** (the Agoran exiles), and **the Encore** (Luminar) all done |
| NPCs | `characters/npcs/` | Korrven, Halda Vorn, Ilsabet Krane, Wrena Calder, Casta Meren, Ereni Thole, Kest Varro, Maro Tallis, Tam Merrival, Bram Harrow, Iveth Kall, Oren Brandt, Dorel Vane, Vess Tallow, Marlow Pitch have files. Wayfair key members (Sera, Ondrel, Brindle) exist inline only; the Gleaner has sketch stats in `the-found.md`; Prismere minor figures (Strake, Gren, Pell, Vairse, Cantrel) are inline in `prismere.md` |
| Locations | `locations/` | Kaldrum, the Stoa, Commonhold, and Prismere done; Meridian still needed |
...
| Kingdom key figures | all five kingdom files | Forgeholm, Sophara, Agoran, Luminar filled; Veritas still a placeholder |
