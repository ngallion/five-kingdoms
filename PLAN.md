...
| Factions | `world/factions/` | Wayfair, the Second Stamp (Forgeholm), the Closed Hand (Sophara), **the Found** (the king's movement), and **the Eleventh Chair** (the Agoran exiles) all done |
| NPCs | `characters/npcs/` | Korrven, Halda Vorn, Ilsabet Krane, Wrena Calder, Casta Meren, Ereni Thole, Kest Varro, Maro Tallis, Tam Merrival, Bram Harrow, Iveth Kall, Oren Brandt have files. Wayfair key members (Sera, Ondrel, Brindle) exist inline only; the Gleaner has sketch stats in `the-found.md` |
| Locations | `locations/` | Kaldrum, the Stoa, and Commonhold done; Meridian and Prismere still needed |
...
| Kingdom key figures | all five kingdom files | Forgeholm, Sophara, Agoran filled; Luminar and Veritas still placeholders |
