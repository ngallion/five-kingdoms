...
One file per NPC. Use `_template.md` as a starting point. Keep this table current — one row per file, grouped by arc.

## The villain & his lieutenants

| NPC | Who they are | Tier | Where |
|-----|--------------|------|-------|
| [Korrven](the-king.md) | Primary villain — exiled Forgeholm wright turned king of Agoran, bonded to Vael | 4 | Commonhold |
| [Bram Harrow](bram-harrow.md) | Warden-General — beloved commander of the King's Wardens (and, unknowing, cover for the Dousers) | 3 | Commonhold / the field |
...
|-----|--------------|-----------|-------|
| [Halda Vorn](halda-vorn.md) | First Wright, chair of the Bench of Masters — ruler of Forgeholm; obstacle, then hinge | Contested | Kaldrum |
| [Wrena Calder](wrena-calder.md) | Struck-off mender, keeper of [the Second Stamp](../../world/factions/the-second-stamp.md) | Ally | Kaldrum (the Chimneys) |

## Sophara arc

| NPC | Who they are | Alignment | Where |
|-----|--------------|-----------|-------|
| [Casta Meren](casta-meren.md) | Prolocutor of the Colloquy — Sophara's de facto ruler; opponent in argument, then hinge | Contested | The Stoa |
| [Ereni Thole](ereni-thole.md) | Retired warder who wants to act — her wards ring the refugee camp; future bearer of Sophara's question | Ally | The Stoa (the fork) |
| [Kest Varro](kest-varro.md) | Censured student, the young face of [the Closed Hand](../../world/factions/the-closed-hand.md) | Contested | The Stoa |

## Luminar arc

| NPC | Who they are | Alignment | Where |
|-----|--------------|-----------|-------|
| [Dorel Vane](dorel-vane.md) | The Luminary — teller of the Undertide, crowned on a story he cannot end; exhausted hinge | Contested | Prismere (the Glasshouse) |
...
| NPC | Who they are | Alignment | Where |
|-----|--------------|-----------|-------|
| [Iveth Kall](iveth-kall.md) | First Steward, keeper of the Hall of Names — the hinge of Commonhold; keeping one name off one list | Contested | Commonhold |
| [Oren Brandt](oren-brandt.md) | The last moot-speaker — elder of [the Eleventh Chair](../../world/factions/the-eleventh-chair.md); the campaign's living archive | Ally | The Downsmoot (Chalklands) |
