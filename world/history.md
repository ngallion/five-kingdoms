...
**Dating:** Year 0 = the Sundering. The present year is **214 AS** (After Sundering). Years before it are marked BS.
...
**What happened (as remembered):** No two kingdoms agree. Luminar remembers a plague of grief that made travel unbearable. Veritas records a "climatic realignment." Forgeholm's ledgers simply stop mentioning foreign orders. Sophara has forty-one competing accounts and endorses none. Agoran remembered it warmest and lost the memory first.
**Why it matters now:** The Sundering is not a habit to be unlearned. It is a spell — still running, powered by the anchors — and it can be broken.

### The Hearts (152–160 AS) — the Resonance Engines

**When:** ~60 years ago.
**What happened:** Enginewrights sinking foundations beneath Forgeholm's capital struck something that hummed. They learned to tap it without ever learning what it was, and within a decade had built and delivered a Heart to every capital — engines that run each kingdom on its own dominant aspect. Self-sufficiency, overnight.
**Why it matters now:** The Hearts extract; they do not create. Luminar's compulsive, disposable art; Veritas's hoarded silence; Sophara's paralysis; Agoran's hollow warmth; Forgeholm's inhuman efficiency — these are extraction symptoms, not moral failings. The kingdoms aren't just starved of each other. They are being *eaten*, and the proceeds flow to Vael. Details per kingdom: [The Anchors & the Hearts](anchors-and-engines.md).

### The Fall of Agoran (209 AS)
...
Player-discoverable cracks in the official story — seed these early:

- Every kingdom's history insists there have "always been five." Yet pre-Sundering trade ledgers (rotting in Veritas archives, hoarded and unread) list tariffs for **six** trade partners. The sixth name blurs on the page and slides out of memory minutes after reading.
- No two maps of the central wilds agree — not on shape, size, or even which rivers enter them. Cartographers call the region the **Hollow March** and stopped trying.
- The Concord Roads all curve toward the Hollow March, then stop dead at its edge, six lanes wide, going nowhere.
- Folk songs in every kingdom share one melody nobody can source — a lullaby with a missing verse. Children sometimes hum the missing verse and can't say where they learned it.
- Every kingdom reads its own two-century-old records without difficulty — yet the same era's *diplomatic* corpus (treaties, tariff schedules, letters between crowns, all in one shared script scholars call the **Concord Tongue**) is unreadable everywhere, and study of it refuses to stick. Philologists shrug it off as a lost merchants' cipher. Nobody asks why friendly kingdoms would need a cipher — or why no key survives in *any* archive.

## GM Notes

**Amaranth, the sixth kingdom.** Its aspect was **Love** — not romance, but the binding itself: the thing that turns creation into gift, knowledge into teaching, tools into help, wisdom into counsel, proximity into belonging. As keystone it took the full force of the inversion and was *unmade* — which is why Vael's own name means "the space where something was." The Hollow March is where Amaranth stood. Something city-shaped is still absent there.
