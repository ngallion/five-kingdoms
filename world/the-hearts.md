# The Hearts — A Gazetteer

**Nature:** The six engines as *places* — where each stands, what its kingdom believes it is, and how it shapes the land around it
**Scope:** Sites, public faces, and ambient effects live here; the mechanism (extraction, re-tune vs. destroy, fuels) is owned by [The Anchors & the Hearts](anchors-and-engines.md)
**See also:** [Religion — the gods in the anchors](religion.md#gm-notes) · [The Hollowing](the-hollowing.md) · [Canon Spine](canon.md)
...
## Forgeholm — the Mother Engine *(the First Heart)*

**Where:** The Root of [Kaldrum](../locations/kaldrum.md) — the mountain's oldest chamber, Ferrun's original sanctum, sealed behind the First Wright's own mark.
**Public face:** The engine that runs the forge-city: the lifts, the rail-runs, the great hammers, the warmth that makes depth status. Kaldrum without the Engine is a cold mountain full of stairs — every wright knows it, and none will risk it.
**The instrument:** **The hum** — through every wall, floor, and teacup in the city; Kaldrumers stop hearing it by their first birthday. The solstice stutter was the first change in the sound in living memory, and forty thousand people woke like a sleeper whose heart skipped.
**The wound around it:** It drinks the *why* of labor. The closer to the Root, the purer the symptom — the deep terraces are the most efficient and least human ground in the five kingdoms, and the gap between those who run machines and those run *by* them is the extraction made visible.
**State:** Stuttering under lattice strain — and the master tap on every anchor *(Herrek's splice — [the-king.md](../characters/npcs/the-king.md#gm-notes))*, which is why the king is coming.

## Sophara — the Still Heart

**Where:** Beneath the Argument — the disputed fork island of [the Stoa](../locations/the-stoa.md), under Sophar's temple garden. Its housing is **the Stillworks**, the squat flood-engine on the island's southern flat.
**Public face:** Flood control. The Meander floods every spring — everywhere but the capital. The Stillworks holds the city's water gentle and its banks dry, and the schools would sooner lose the Colloquy Hall than the thing that keeps the river polite.
**The instrument:** **The still water** — the Meander lies mirror-flat and silent through the whole capital; boatmen pole across a river that never ripples. When the lattice strains, the water *shows current* — and since the refugee camp landed on the island, there are ripples some mornings.
...
**Where:** Beneath the Understage of the Glasshouse, [Prismere](../locations/prismere.md)'s great theater on its own islet. The famous stage machinery everyone thinks the Glasshouse was built around is the Heart's public face — the "thousand doors" name migrated from engine to theater within a generation.
**Public face:** The greatest stage in the world: trapdoors, light-gates, and water-sluices that can conjure anything. Every debut that matters happens over the Heart — which is why a Glasshouse Gasp crowns Luminaries, and why the kingdom's most sacred stage is the extraction's open mouth.
**The instrument:** **The tide-applause** — twice a day the tide runs the sea-gates under the causeways, and the sound is exactly applause. Lately there are nights the tide misses its cue; the whole city hears it, and nobody discusses it.
**The wound around it:** It drinks completion. The city literally cannot see finished things — eyes slide off yesterday's marvels — and the wound pools in the Fade, the quarter of drained masterpieces kept dry and ignored, a short walk from the stage that drank them.
**State:** Three years starved and straining toward one withheld meal — the Undertide's unfinished finale ([Prismere — GM Notes](../locations/prismere.md#gm-notes)).

## Agoran — the Warm Heart *(now the King's Heart)*

**Where:** Beneath the Ring — [Commonhold](../locations/commonhold.md)'s great moot-ring, Tavan's temple-that-was-never-a-building. Its housing is the **Common Hearth**, built over the moot's ancient fire-pit.
**Public face:** The mother-flame of a kingdom: it heats the ring-barns and bakehouses, drives the great mills, and by custom every hearth-fire in Agoran is lit from it. The fire *is* Agoran's sense of itself — which is precisely what made the Fall feel like a revival.
**The instrument:** **The leaning flame** — the Hearth burns taller these last five years than in living memory, and it leans, whatever the wind does, toward the head of the king's table. Agorans say the fire pays its respects. On rare nights it gutters, or stands suddenly straight, and the Ring goes quiet without knowing why.
**The wound around it:** It drank warmth-toward-strangers for sixty years, hollowing the feasts from the inside — and since 209 the wound has a tenant: Korrven's partial re-tuning routes the belonging *through him*. Commonhold is the warmest place in the world again, and every degree of it flows past the head table.
**State:** Partially re-tuned toward the king — the first node of his new lattice, and the campaign's climax ([Commonhold — GM Notes](../locations/commonhold.md#gm-notes)).
